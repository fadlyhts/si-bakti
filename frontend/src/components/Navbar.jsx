...
const Navbar = () => {
  ...
  const [addUserForm, setAddUserForm] = useState({
    username: '',
    password: '',
    role: 2 // Default to VIEWER role (role 2)
  });
  ...
  const openAddUserModal = () => {
    ...
    setAddUserForm({ username: '', password: '', role: 2 });
  };
  ...
  const handleAddUserSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Form data:', addUserForm);
      ...
      const result = await createUser(addUserForm);
      ...
      setMessage({ 
        type: 'error', 
        text: error.response?.data?.message || error.message || 'Gagal menambahkan user' 
      });
    } finally {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ margin: 0, color: 'var(--text-dark)' }}>Tambah User Baru</h3>
            <button
          ...
          <form onSubmit={handleAddUserSubmit}>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              >
                <option value={2}>Viewer (Role 2)</option>
